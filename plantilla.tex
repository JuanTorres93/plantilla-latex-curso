% Author: Juan Torres
% Template for Industrial Engineering Master
...
\def\LANGUAGE{<++>} %EN, ES		%Language in which the document is going to be written.

\def\reportTile{<++>}			%Document's title
\def\subject{<++>}			%Subject

\def\writter{Juan Torres}		%Author(s)
...
\def\university{University of Castilla - La Mancha}
...
\def\university{Universidad de Castilla - La Mancha}
...
\begin{titlepage}
	...
	\def\logoSize{0.2}
	\begin{figure}
	\includegraphics[width=\logoSize\linewidth]{Images/Icono_industriales.png}
	\hfill
	\includegraphics[width=\logoSize\linewidth]{Images/Icono_UCLM.png}
	\end{figure}
